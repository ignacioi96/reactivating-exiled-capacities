    ...
    toSVGPath() {
        ...
        for (let i = 1; i < this.points.length; i++) {
            ...
            if (i === 1) {
                ...
                path += ` Q ${current.position.x} ${current.position.y}`;
            } else if (i === this.points.length - 1) {
                // Last point
                path += ` ${current.position.x} ${current.position.y}`;
            } else {
...
function triggerTargetedMycelium2D() {
